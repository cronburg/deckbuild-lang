...
terms. There exists software such as Dominion Online\cite{DomOnline} or Magic the Gathering Online \cite{MTGOnline} which exists as
a way to play those offical titles with people or against AI.
The closest competitor for DeckBuild is Dominiate, an
open source project by Robert Speer that is a Dominion Simulator written in coffeescript.\cite{Dominiate}
\\

...
player1.action {
  ...
  actionPhaseHeuristic =
    ...
    in case () of
      _ | actionsLeft > 0 = do {play bestAction; actionPhaseHeuristic}
...
player1.buy {
  ...
  buyPhaseHeuristic =
    let bestBuy = mostExpensive $ filter (\c -> (cost c) <= player1Coins) (actions boardCards)
    in case () of
     _ | buysLeft > 0 = do {buy bestBuy; buyPhaseHeuristic}
